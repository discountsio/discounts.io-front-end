...
const DATA_sortOrderRadios = [
  { name: "Best Offer", id: "offer_percentage:DESC" },
  { name: "Best Rating", id: "rating:DESC" },
  // { name: "Newest", id: "Newest" },
  { name: "Price Low - Hight", id: "price_now:ASC" },
  { name: "Price Hight - Low", id: "price_now:DESC" },
];
...
const TabFilters = (props: any) => {
  ...
  const handleSortOrderChange = () => {
    props.setSortKey(sortOrderStates)
  }
                  ...
                  <div className="relative flex flex-col px-5 py-6 space-y-5">
                    {DATA_sortOrderRadios.map((item) => (
                      <Radio
                        ...
                        onChange={() => { setSortOrderStates(item.id) }}
                      />
                    ))}
                  </div>
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
